...
class ManagerCommunity extends StatefulWidget {
  const ManagerCommunity({Key? key}) : super(key: key);

  @override
  State<ManagerCommunity> createState() => _ManagerCommunityState();
}

class _ManagerCommunityState extends State<ManagerCommunity>
