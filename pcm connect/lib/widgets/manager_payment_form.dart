...
class ManagerPaymentForm extends StatefulWidget {
  const ManagerPaymentForm({
    Key? key,
  ...
  @override
  State<ManagerPaymentForm> createState() =>
      _ManagerPaymentFormState(reservation);
}

class _ManagerPaymentFormState extends State<ManagerPaymentForm>
  ...
  _ManagerPaymentFormState(this.reservation);
  @override
